...
CUV_history = CUVModel.fit(CUV_X_train, CUV_Y_train, epochs=100, batch_size=10, verbose=2)
MUV_history = MUVModel.fit(MUV_X_train, MUV_Y_train, epochs=100, batch_size=10, verbose=2)
